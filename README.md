...
| Release | Asset | For |
|---|---|---|
| [`v0.7.0-arch`](https://github.com/Local-DE-Coach/public/releases/tag/v0.7.0-arch) | `shadowing-engine-0.7.0-archlinux.zip` | Arch Linux — CPU-only, tabbed TUI, one-key browser setup |
