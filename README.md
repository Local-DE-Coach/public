...
| Release | Asset | For |
|---|---|---|
| [`v0.6.1-arch`](https://github.com/Local-DE-Coach/public/releases/tag/v0.6.1-arch) | `shadowing-engine-0.6.1-archlinux.zip` | Arch Linux — CPU-only, tabbed TUI, one-key browser setup |
